...
#pragma config(Motor,  port2,           liftMotor,     tmotorNone, openLoop)
#pragma config(Motor,  port3,           liftMotor1,    tmotorNone, openLoop)
#pragma config(Motor,  port4,           liftMotor2,    tmotorNone, openLoop)
#pragma config(Motor,  port5,           liftMotor3,    tmotorNone, openLoop)
#pragma config(Motor,  port6,           armMotor,      tmotorVex393_MC29, openLoop)
#pragma config(Motor,  port7,           armMotor1,     tmotorVex393_MC29, openLoop)
