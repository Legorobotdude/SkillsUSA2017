...
#pragma config(Motor,  port1,           rightMotor,    tmotorVex393_HBridge, openLoop, reversed, driveRight, encoderPort, I2C_1)
...
#pragma config(Motor,  port10,          leftMotor,     tmotorVex393_HBridge, openLoop, driveLeft, encoderPort, I2C_2)
...
SensorValue(Encoder) = 0;
  ...
  //displayLCDString(value);   // Display "Hello from"
  displayLCDNumber( SensorValue(Encoder), 0, 0)
  ...
  else
  {
   ...
   if(vexRT[Btn8D] == 1)
    ...
    else
    {
      ...
      motor[liftMotor3] = 0;
      */
      if(abs(SensorValue(Encoder))>180)
      {
      	motor[liftMotor4] = 0;
      motor[liftMotor1] = 0;
      motor[liftMotor2] = 0;
      ...
      else if(abs(SensorValue(Encoder))>90)
      {
      	motor[liftMotor4] = -2;
      motor[liftMotor1] = -2;
      motor[liftMotor2] = -2;
    ...
    else if(abs(SensorValue(Encoder))>30)
    {
    	motor[liftMotor4] = -2;
      motor[liftMotor1] = -2;
      motor[liftMotor2] = -2;
